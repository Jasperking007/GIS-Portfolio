## Terrain Analysis of Survey Area (ArcGIS Pro)

### Overview
This project involved terrain analysis using Digital Elevation Model (DEM) data to understand elevation variation, slope, and surface characteristics of the study area.

---

### Methods
- Generated DEM from elevation data  
- Derived slope map from DEM  
- Created 3D terrain model  
- Extracted elevation profile along selected transect  
